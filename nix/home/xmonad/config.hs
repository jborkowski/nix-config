...
myKeys conf@XConfig {XMonad.modMask = modm} =
  keySet
    ...
    ^++^ keySet
      "Brightness"
      [ key "Increase Display Brightness" (0, xF86XK_MonBrightnessUp) $ spawn "brightnessctl set +4%",
        key "Decrease Display Brightness" (0, xF86XK_MonBrightnessDown) $ spawn "brightnessctl set 4-%",
        key "Increase Keyboard Brightness" (0, xF86XK_KbdBrightnessUp) $ spawn "brightnessctl set +4%",
        key "Decrease Keyboard Brightness" (0, xF86XK_KbdBrightnessDown) $ spawn "brightnessctl set 4%-"
      ]
    ^++^ keySet
      "Launchers"
